...
各功能包功能如下：
- lowindowbot_description 机器人描述文件，包含仿真相关配置
- lowindowbot_navigation2 机器人导航配置文件
- lowindowbot_application 机器人导航应用 Python 代码
- lowindowbot_application_cpp 机器人导航应用 C++ 代码
...
ros2 launch lowindowbot_description gazebo_sim.launch.py
```
...
```
source install/setup.bash
ros2 launch lowindowbot_navigation2 navigation2.launch.py
```
